...
class TestConfigFileGeneration(TestCase):
    ...
    def test_generate_config_file_acr(self):
        ...
        training_filedir = NestConfig.media_path('mp4', 'cvxhull_subjexp', 'You')
        reliability_filedir = NestConfig.media_path('mp4', 'cvxhull_subjexp', 'GOViveATu')
        testing_filedir = NestConfig.media_path('mp4', 'cvxhull_subjexp', 'CT')
