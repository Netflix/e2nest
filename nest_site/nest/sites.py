...
class NestSite(ExperimentMixin):
    """
    ...
    @method_decorator(never_cache)
    def aom_demo_with_preload_s3(self, request, extra_context=None):
        page = SamviqPage({
            'title': 'Round 1 of 10',
            'video_ref': 'https://netflix-encoding-subjective-testing.s3.us-west-1.amazonaws.com/media/mp4/aom_demo_stimuli/DrivingPOV3.5.A.mp4',  # noqa E501
            'button_ref': 'Reference',
            'videos': ['https://netflix-encoding-subjective-testing.s3.us-west-1.amazonaws.com/media/mp4/aom_demo_stimuli/Marathon2.3.A.mp4',  # noqa E501
                       'https://netflix-encoding-subjective-testing.s3.us-west-1.amazonaws.com/media/mp4/aom_demo_stimuli/TallBuildings2.0.A.mp4',  # noqa E501
                       ],
            'buttons': ['A', 'B'],
            'stimulusvotegroup_ids': [0, 1],
            'video_display_percentage': 100,
    ...
    @method_decorator(never_cache)
    def demo_4kplus_with_preload_s3(self, request, extra_context=None):
        page = SamviqPage({
            'title': 'Round 1 of 10',
            'video_ref': 'https://netflix-encoding-subjective-testing.s3.us-west-1.amazonaws.com/media/mp4/4kplus_study_demo/LifeInColor_B/LifeInColor_B__3_22_3_27__SdrVvhevceCrfVE__3820_2160__qp14_enable_audio_False_level_51_vmaf63.88_phonevmaf83.20_psnr23.51_kbps39289.47.mp4',  # noqa E501
            'button_ref': 'Reference',
            'videos': ['https://netflix-encoding-subjective-testing.s3.us-west-1.amazonaws.com/media/mp4/4kplus_study_demo/SolLevante_A/SolLevante_A__0_24_0_29__SdrVvhevceCrfVE__3820_2160__qp14_enable_audio_False_level_50_vmaf62.39_phonevmaf81.78_psnr22.02_kbps24650.51.mp4',  # noqa E501
                       'https://netflix-encoding-subjective-testing.s3.us-west-1.amazonaws.com/media/mp4/4kplus_study_demo/SMendesConcert_A/SMendesConcert_A__83_21.9_83_26.9__SdrVvhevceCrfVE__3820_2160__qp14_enable_audio_False_level_50_vmaf58.94_phonevmaf78.94_psnr25.44_kbps25447.21.mp4',  # noqa E501
                       ],
            'buttons': ['A', 'B'],
            'stimulusvotegroup_ids': [0, 1],
            'video_display_percentage': 100,
    ...
    @method_decorator(never_cache)
    def demo_4kplus_with_preload_s3_b(self, request, extra_context=None):
        page = SamviqPage({
            'title': 'Round 1 of 10',
            'video_ref': 'https://netflix-encoding-subjective-testing.s3.us-west-1.amazonaws.com/media/mp4/4kplus_study_demo/LifeInColor_B/LifeInColor_B__3_22_3_27__SdrVvhevceCrfVE__3820_2160__qp14_enable_audio_False_level_51_vmaf63.88_phonevmaf83.20_psnr23.51_kbps39289.47.mp4',  # noqa E501
            'button_ref': 'Reference',
    ...
    def demo_live_a(self, request, extra_context=None):
        page = Samviq5dPage({
            ...
            'instruction_html':
                """<p> Instruction: Click on each "x Mbps" button to begin playing a video. Video will loop. <em> Press "space" key or double click the mouse </em> to exit.</p>""",  # noqa E501
            'question':
